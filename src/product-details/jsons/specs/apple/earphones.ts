const productSpecs = [
      ...
      },
      {
        ...
        values: {
          'Other Sound Features':
            'Transparency Mode, Adaptive EQ, Spatial Audio with Dynamic Head Tracking',
        },
      },
      {
      ...
      },
      {
        ...
        values: {
          'Other Power Features':
            '5 Minutes of Charge Gives 1.5 Hours of Listening Time',
        },
      },
      {
        title: 'Dimensions',
  ...
  {
    productCode: 'apple-airpods-2',
    productSpecs: [
      {
        title: 'General',
        values: {
          'Model Name': 'Apple Airpods (2nd generation)',
          'Headphone Type': 'True Wireless',
          'Inline Remote': 'No',
          Connectivity: 'Bluetooth',
        },
  ...
  {
    productCode: 'apple-airpods-1',
    productSpecs: [
      {
        title: 'General',
        values: {
          'Model Name': 'Apple Airpods (1st generation)',
          'Headphone Type': 'True Wireless',
          'Inline Remote': 'No',
          Connectivity: 'Bluetooth',
        },
