...
export class CarouselItemsService {
  ...
  async addMany() {
    await this.carouselItemModel.insertMany([
      {
        imageUrl:
          'https://unboxedkart-india.s3.ap-south-1.amazonaws.com/carousels/mobile/brand/google/1.webp',
      ...
      {
        imageUrl:
          'https://unboxedkart-india.s3.ap-south-1.amazonaws.com/carousels/mobile/brand/google/2.webp',
      ...
      {
        imageUrl:
          'https://unboxedkart-india.s3.ap-south-1.amazonaws.com/carousels/mobile/brand/google/3.webp',
      ...
      {
        imageUrl:
          'https://unboxedkart-india.s3.ap-south-1.amazonaws.com/carousels/1.webp',
        productCode: 'apple-iphone-13-pro',
        isExact: true,
        title: 'iPhone 13 Pro',
