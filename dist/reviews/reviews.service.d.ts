...
export declare class ReviewsService {
    ...
    getProductReviews(productId: string): Promise<(import("mongoose").Document<unknown, any, Review> & Review & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    ...
    approveReview(userId: string, entireBody: ApproveReviewDto): Promise<void>;
}
