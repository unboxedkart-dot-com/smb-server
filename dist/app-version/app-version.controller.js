...
const create_app_version_dto_1 = require("./dto/create-app-version.dto");
let AppVersionController = class AppVersionController {
    constructor(appVersionService) {
        this.appVersionService = appVersionService;
    }
    create(createAppVersionDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_app_version_dto_1.CreateAppVersionDto]),
