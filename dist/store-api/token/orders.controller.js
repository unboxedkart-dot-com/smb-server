...
let StoreTokenController = class StoreTokenController {
    ...
    async handleGetReferrals(request, entireBody) {
        const userId = request.user.userId;
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_a = typeof UpdateUserPaymentDetailsDto !== "undefined" && UpdateUserPaymentDetailsDto) === "function" ? _a : Object]),
    __metadata("design:returntype", Promise)
], StoreTokenController.prototype, "handleGetReferrals", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], StoreTokenController.prototype, "handleCreateOrder", null);
