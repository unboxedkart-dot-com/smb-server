    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: 'Enquiry', schema: token_model_1.StoreTokenSchema },
            ], 'storeDb'),
            mongoose_1.MongooseModule.forFeature([{ name: 'StoreNotification', schema: store_notification_model_1.StoreNotificationSchema }], 'storeDb'),
            mongoose_1.MongooseModule.forFeature([
